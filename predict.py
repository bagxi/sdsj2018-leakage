...
from leakages import use_time_leakage
...
if __name__ == '__main__':
    ...
    if model_config['time_leakage']['is_leakage']:
        df[model_config['time_leakage']['id_col']] = model_config['time_leakage']['id_series']
        df[model_config['time_leakage']['dt_col']] = model_config['time_leakage']['dt_series']
        df[model_config['time_leakage']['num_col']] = model_config['time_leakage']['num_series']
